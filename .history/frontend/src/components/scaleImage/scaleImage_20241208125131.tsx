...
const ScaleImage: React.FC<Props> = ({ src, alt }) => {
  ...
  return (
    ...
    >
      ...
      ">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Neque repellendus, ducimus quo dolore repudiandae in quaerat saepe quia fuga cumque eligendi consequuntur quibusdam, illum quos.</p>
        {/* Image */}
