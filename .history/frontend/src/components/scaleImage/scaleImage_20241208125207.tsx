...
const ScaleImage: React.FC<Props> = ({ src, alt }) => {
  ...
  return (
    ...
    >
       ...
       absolute top-10 left-1/2 -translate-x-1/2 text-2xl md:text-4xl font-bold  p-4 rounded-lg"
      >
      ...
      -translate-x-1/2
      w-full px-4
      top-10 text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Neque repellendus, ducimus quo dolore repudiandae in quaerat saepe quia fuga cumque eligendi consequuntur quibusdam, illum quos.</p>
        {/* Image */}
