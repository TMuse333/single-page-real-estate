...
const ScaleImage: React.FC<Props> = ({ src, alt }) => {
  ...
  const scale = useTransform(scrollYProgress, [0, 0.5, 0.7, 1], [!scaleComplete ?0.7 : 1, 1, 1, 0.95],  { ease:easeIn });
  ...
  return (
    ...
    >
        ...
        sm:text-5xl  md:text-6xl opacity-0 translate-y-[-6rem]">Lorem ipsum dolor sit amet consectetur.
        </h2>
