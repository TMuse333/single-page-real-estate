...
const ScaleImage: React.FC<Props> = ({ src, alt }) => {
  ...
  const scale = useTransform(scrollYProgress, [0, 0.3, 0.7, 1], [!scaleComplete ?0.7, 1, 1, 0.7],  { ease:easeIn });
  ...
  return (
    ...
    >
        ...
        sm:text-5xl md:text-6xl">Lorem ipsum dolor sit amet consectetur.
        </motion.h2>
