...
const ScaleImage: React.FC<Props> = ({ src, alt }) => {
  ...
  return (
    ...
    >
      ...
      -translate-x-1/2
      w-full px-4
      top-10 text-black">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Neque repellendus, ducimus quo dolore repudiandae in quaerat saepe quia fuga cumque eligendi consequuntur quibusdam, illum quos.</p>
        {/* Image */}
