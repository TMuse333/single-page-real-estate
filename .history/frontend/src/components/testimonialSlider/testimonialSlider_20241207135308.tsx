...
const TestimonialBox: React.FC<{
  ...
  const totalTranslateDistance = (): number => {
    const distance = isMobile ? (lineDistance/2) : (lineDistance-2) 
    const buffer = isMobile ? 225 : 225
  ...
  return (
    <motion.div
      ref={ref}
      className={`w-[60vw] min-w-[600px] flex flex-col items-center justify-center text-center py-8 px-4 bg-blue-400 rounded-2xl
