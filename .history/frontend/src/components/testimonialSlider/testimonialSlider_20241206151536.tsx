...
useEffect(() => {
  const interval = setInterval(() => {
    setTranslateValue((prevValue) => prevValue - 1); // Increase the value by 1
  }, 10); // Update the value every 10 milliseconds (you can adjust this for speed)
  ...
  return (
    <motion.div
      ...
      rounded-2xl translate-x-[${translateValue}px]`}
