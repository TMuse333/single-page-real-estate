...
const inView = useInView(ref,{
  ...
  const calculateInitialTransform = (index: number): string => {
    ...
    return index === 0 ? "0px" : `calc(${index} * (60vw + 100px))`;
  };
  

  const initialTransformVaue = calculateInitialTransform(index)
  ...
  return (
    ...
    ref={ref}
      ...
      style={{ transform:`translateX(${initialTransform}px)`  }}
    >
      <img
        src={imageSrc}
        alt={name}
