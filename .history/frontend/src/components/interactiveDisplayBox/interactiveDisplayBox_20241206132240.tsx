...
const InteractiveBox: React.FC<InteractiveBoxProps> = ({
    ...
    return (
      <div
        className={`relative w-[90vw] sm:w-[45vw] mx-auto mb-8 h-[60vh] rounded-3xl overflow-hidden transition-opacity ${
            ...
            <AnimatePresence mode="wait">
              {!isHovered ? (
                ...
                realEstateStats.map((stat, index) => (
                  <motion.div
                    className="flex flex-row w-full bg-red-200"
                    key={index} // Use the index for the unique key
