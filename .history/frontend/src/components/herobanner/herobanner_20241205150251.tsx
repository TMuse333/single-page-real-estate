      ...
      >
        ...
        items-center ">
           ...
           md:hidden rounded-full bg-gray-600
            ...
            text-xl">
               Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur minima debitis quod ullam voluptatem minus cum id atque adipisci facilis. Fuga sequi aliquam, officia mollitia accusamus consequatur, sapiente consequuntur molestias ad explicabo ex, voluptates quo. Tempore reiciendis porro asperiores quasi!
            </p>
            <TypeWriter
            />
