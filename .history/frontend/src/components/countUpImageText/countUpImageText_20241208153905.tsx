...
const CountUpImageText:React.FC<Props> = ({
    ...
    return (
        ...
        md:flex-row-reverse mx-auto max-w-[1200px]">
            <motion.h2 className="mx-auto
            text-3xl text-black font-bold
            text-center sm:text-4xl
            md:text-5xl
            mt-12 mb-4 md:hidden">{title}</motion.h2>
...
flex-col px-4 md:w-[48vw] ">
      <motion.h2 className="mx-auto
            ...
            text-center sm:text-4xl
            md:text-5xl
            mt-12 mb-4 hidden md:block">{title}
            </motion.h2>
<motion.p className="text-black md:px-4
font-semibold
    mb-6 "> 
        {description}
    </motion.p>
