    ...
    const fadeInVariants = (delay: number) => {
      ...
      return (
        ...
        >
          ...
          ">
            <p className={`text-black py-2  bottom-0 left-1/2
            -translate-x-1/2 px-4 bg-gray-400
            text-3xl z-[2] absolute transition-all
            ${inView ? 'opacity-1 delay-1000' : 'opacity-0 delay-0'}
          ...
          <section className="flex flex-col px-4 md:w-[48vw]">
            ...
            <section
            ref={ref2} 
            className="flex mx-auto flex-col justify-center items-center md-[-12rem] md:mt-4 md:flex-row font-semibold md:mr-auto md:ml-4
            ">
              {/* Stats Loop */}
