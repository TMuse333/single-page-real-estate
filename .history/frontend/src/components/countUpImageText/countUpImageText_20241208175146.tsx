    ...
    const fadeInVariants = (delay: number) => {
      ...
      const pVar = (delay: number) => {
        ...
        return {
            ...
            transition: {
              duration: 0.2,
              delay: 10, // Delay based on the parameter
              ease: "easeInOut"
            }
        }
          ...
          <section className="relative w-[98vw] md:w-[48vw] md:block h-[80vh]">
            ...
            <Image
              ...
              className={`w-full h-full rounded-2xl
               object-cover mx-auto md:block h-[80vh] mt-auto mb-auto absolute"
              style={{
                borderRadius: "1rem"
              }}
            />
              ...
              <div className="text-2xl mb-6 flex flex-col justify-start items-start">
                {stats.map((stat, index) => {
                  const delay = 0.2 + index * 0.2;
                   const nameDelay = 0.25 + index * 0.2
                  return (
                    <div
                      key={index}
                    ...
                    >
                      ...
                      <motion.p 
                      variants={fadeInVariants(nameDelay)}
                      initial="initial"
                      animate={inView ? "animate" : "initial"}
